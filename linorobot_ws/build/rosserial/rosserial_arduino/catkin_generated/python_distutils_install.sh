...
echo_and_run cd "/home/bros/linorobot_ws/src/rosserial/rosserial_arduino"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/bros/linorobot_ws/src/rosserial/rosserial_arduino/setup.py" \
     \
    build --build-base "/home/bros/linorobot_ws/build/rosserial/rosserial_arduino" \
    install \
    --root="${DESTDIR-/}" \
