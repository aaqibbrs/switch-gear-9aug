...
echo_and_run cd "/home/bros/linorobot_ws/src/rosserial/rosserial_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/bros/linorobot_ws/src/rosserial/rosserial_python/setup.py" \
     \
    build --build-base "/home/bros/linorobot_ws/build/rosserial/rosserial_python" \
    install \
    --root="${DESTDIR-/}" \
