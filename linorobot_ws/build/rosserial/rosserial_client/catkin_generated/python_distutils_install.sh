...
echo_and_run cd "/home/bros/linorobot_ws/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/bros/linorobot_ws/src/rosserial/rosserial_client/setup.py" \
     \
    build --build-base "/home/bros/linorobot_ws/build/rosserial/rosserial_client" \
    install \
    --root="${DESTDIR-/}" \
