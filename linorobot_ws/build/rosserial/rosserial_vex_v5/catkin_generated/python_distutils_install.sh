...
echo_and_run cd "/home/bros/linorobot_ws/src/rosserial/rosserial_vex_v5"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/bros/linorobot_ws/src/rosserial/rosserial_vex_v5/setup.py" \
     \
    build --build-base "/home/bros/linorobot_ws/build/rosserial/rosserial_vex_v5" \
    install \
    --root="${DESTDIR-/}" \
